...
function deploy(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, execute_1.execute)(`chown -R $(id -u):$(id -g) ${action.folderPath}`, action.workspace, action.silent);
            /*
            ...
            yield (0, execute_1.execute)(`git checkout -B ${temporaryDeploymentBranch}`, `${action.workspace}/${temporaryDeploymentDirectory}`, action.silent);
            yield (0, execute_1.execute)(`chown -R $(id -u):$(id -g) ${temporaryDeploymentDirectory}`, action.workspace, action.silent);
